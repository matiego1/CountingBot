...
public enum Translation {
    ...
    COMMANDS__RANKING__HEADER("**Total number of messages in all guilds:** `%s`\n**Total number of messages in this guild:** `%s`\n\n"),
    ...
    TYPE__LUCAS_SEQUENCE__NAME("Lucas numbers"),
    TYPE__LUCAS_SEQUENCE__DESCRIPTION("Write next numbers of the lucas sequence"),
    //others
